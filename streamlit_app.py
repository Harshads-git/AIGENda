...
genai.configure(api_key="AIzaSyCTfmlFDR3REcFbkbStHpgCIjenlSrBtgM") #config.
...
st.set_page_config(page_title="Harshad's Invoice generator")
st.sidebar.header("Robobill")
st.sidebar.write("Made by Harshad S")
st.sidebar.write("Powered by Google Gemini AI")
st.header("Robobill")
st.subheader("Made by Harshad")
